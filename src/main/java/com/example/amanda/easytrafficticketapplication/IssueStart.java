...
public class IssueStart extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_issue_start);
...
// Starting Activity
    ...
    public void nn(View c) {
        Intent intent = new Intent(this, IssueTick2.class);
        String ab = "B2289353";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 10000) {
            if (resultCode == BlinkOCRActivity.RESULT_OK && data != null) {
                ...
                Toast.makeText(IssueStart.this, email.toString(), Toast.LENGTH_LONG).show();
                Toast.makeText(IssueStart.this, email.toString(), Toast.LENGTH_LONG).show();
